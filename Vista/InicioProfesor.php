...
include '../Controlador/ValidarSesionP.php'
?>
<html>
<head>
...
<body bgcolor="black">
	 <section>
	 	<table>
	 		<thead>
	 		<h1 class="Bienvenida"><img class="ImgAdmin" src="../Vista/img/login_profesor.png" width="100px" height="100px">Bienvenido Docente</h1>
	 		</thead>
	 		<tbody>
	 			<tr>
